...
export function liveWorkbenchCard(item) {
  ...
  return {
    id:item.id,
    source_id:item.source_id,category:item.category,tags:item.tags,cover_id:item.cover_id,cover_url:item.cover_url,cover_caption:item.cover_caption,date:item.published_at?.slice(0,10),excerpt:item.text,
